...
import Ihor from "../assets/images/ihor.jpg";
...
const companies = [
  {
    ...
    description:
      <>В мої обов&apos;язки входило створення та розрахунки інвестиційних запросів та проєктів для покращення
        підприємницької діяльності. Також я займався стратегічним плануванням та прогнозуванням бізнес моделі FXPO</>,
  }
];
          ...
          <div className="about-me-contacts__wrapper">
            <div className="about-me-contacts__info">
              ...
              <p className="about-me-contacts__quote">
                ...
                Після чого я зрозумів що це не моє, але не зупинився...
              </p>
